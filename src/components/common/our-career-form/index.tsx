                            ...
                            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                                ...
                                <FormField
                                    ...
                                    render={({ field: { onChange, ref }, fieldState }) => (
                                        <FormItem>
                                            <FormLabel className="font-medium text-sm sm:text-xl">Resume Upload *</FormLabel>
                                            <FormControl>
                                                <Input
                                                    type="file"
                                                    accept=".pdf,.doc,.docx"
                                        ...
                                        <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                                            ...
                                            <div className="space-y-1 leading-none">
                                                <FormLabel className="text-xs sm:text-base">
                                                    I authorize IceApple to collect and use my info for this
                                                    application.
                                                </FormLabel>
                                            </div>
                                            <FormMessage />
                                ...
                                {submitStatus && (
                                    <div
                                        className={`p-3 mt-2 rounded ${submitStatus.type === "success"
